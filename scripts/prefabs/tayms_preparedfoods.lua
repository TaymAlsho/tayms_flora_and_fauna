--this is a copy of preparedfoods but with some changes to file names to make inventory images + builds work 
...
local function MakePreparedFood(data)
	local foodassets =
	{
        ...
        Asset("ATLAS", "images/cookbookimages/"..data.name..".xml"),
        Asset("IMAGE", "images/cookbookimages/"..data.name..".tex"),
	}
    ...
    local function fn()
        ...
        if spicename ~= nil then
            ...
            inst.inv_image_bg = { image = data.name..".tex", atlas =  "images/inventoryimages/"..data.name..".xml"}
...
for k, v in pairs(require("tayms_preparedfoods")) do
